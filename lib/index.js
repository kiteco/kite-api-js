...
const KiteAPI = {
  ...
  getHoverDataAtPosition(filename, source, position, editor, encoding) {
  ...
  getReportDataAtPosition(filename, source, position, editor, encoding) {
  ...
  getCompletionsAtPosition(filename, source, position, editor, encoding) {
  ...
  getSnippetCompletionsAtPosition(filename, source, editor, encoding, start_position, end_position = start_position) {
    checkArguments(this.getSnippetCompletionsAtPosition, filename, source, editor, encoding, 
  ...
  getSignaturesAtPosition(filename, source, position, editor, encoding) {
